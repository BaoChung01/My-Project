 ...
 */
uint16_t GPIOReadFromInputPort(GPIO_RegDef_t *pGPIOx)
{
	uint16_t value;
...
*/
void GPIO_IRQPritorityConfig(uint8_t IRQNumber, uint32_t IRQPriority)
{
	//1.first lets find out the IPX register
