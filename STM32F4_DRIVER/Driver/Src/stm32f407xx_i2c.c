...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	tempreg = 0;
	tempreg |= pI2CHandle->I2C_Config.I2C_DeviceAddress << I2C_CR2_FREQ;
	tempreg |= (1 << 14);
...
void I2C_MasterSendData(I2C_Handle_t *pI2CHandle,uint8_t *pTxbuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr)
{
	...
	//2. confirm that start condition generation is completed by check ing the SB flag in SR1
	...
	// note until ADDR is cleared SCL will stretched (pulled to LOW)
	...
	//7. when len become 0 wait for TXE = 1 and BTF = 1  before generating the STOP condition
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle,uint8_t *pRxbuffer, uint32_t Len, uint8_t SlaveAddr,uint8_t Sr)
{
	...
	//3. send the address of the slave with r/w bit set R(1) (total 8 bits)
	...
	if(Len > 1)
	{
		//clear the data until becomes zero
